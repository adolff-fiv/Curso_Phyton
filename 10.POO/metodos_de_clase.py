class Celular: # Molde principal
    ...
    # Método ToString
    def __str__(self):
        return f'''\n Imprimiendo datos del celular por el método ToString
...
samsung.set_almacenamiento(256), samsung.set_camara(64), samsung.encender()

print('Comprobando sus componentes') if samsung.get_encendido() else print("Aún no se puede encender el celular ")
