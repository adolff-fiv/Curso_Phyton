...
print("Texto encontrado" if re.search(".endien.", cadena, re.IGNORECASE) is not None else "texto NO encontrado")

textoEncontrado = re.search(textoBuscar, cadena, re.IGNORECASE)
print("El texto encontrado inicia con el caracter: ", textoEncontrado.start())
